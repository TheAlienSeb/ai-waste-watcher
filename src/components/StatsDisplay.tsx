    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <Card className="p-3 bg-white/60 backdrop-blur-sm border-yellow-100 shadow-sm">
        <div className="flex items-center mb-2">
          ...
          <h3 className="text-sm font-medium text-yellow-700">Energy Used</h3>
        </div>
        <div className="mt-1">
          <div className="text-lg font-semibold">{formatNumber(stats.energyConsumption)} J</div>
          <Progress value={Math.min(stats.energyConsumption / 20, 100)} className="h-1.5 mt-1 bg-yellow-100" />
          <p className="text-xs mt-1 text-yellow-600">
            {(stats.energyConsumption / 3600).toFixed(4)} Wh
          </p>
        </div>
      </Card>
